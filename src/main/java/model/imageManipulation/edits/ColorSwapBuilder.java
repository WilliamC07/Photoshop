...
public class ColorSwapBuilder extends AbstractEditBuilder implements RequirePoints {
    /**
     * Points given to construct this rectangle.
     * Only two points are required to make a rectangle.
     */
    private ColorPicker iColorPicker, fColorPicker;
    ...
    public ColorSwapBuilder(ImageBuilder imageBuilder, ColorPicker iColorPicker, ColorPicker fColorPicker){
        this.imageBuilder = imageBuilder;
        this.iColorPicker = iColorPicker;
        this.fColorPicker = fColorPicker;
    }
